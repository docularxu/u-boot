...
CCU_PLL_DEFINE(CLK_PLL1, pll1, "clock-24m", pll1_rate_tbl, APBS_PLL1_SWCR1,
	       APBS_PLL1_SWCR3, MPMU_POSR, POSR_PLL1_LOCK, CLK_SET_RATE_GATE);
CCU_PLL_DEFINE(CLK_PLL2, pll2, "clock-24m", pll2_rate_tbl, APBS_PLL2_SWCR1,
	       APBS_PLL2_SWCR3, MPMU_POSR, POSR_PLL2_LOCK, CLK_SET_RATE_GATE);
CCU_PLL_DEFINE(CLK_PLL3, pll3, "clock-24m", pll3_rate_tbl, APBS_PLL3_SWCR1,
	       APBS_PLL3_SWCR3, MPMU_POSR, POSR_PLL3_LOCK, CLK_SET_RATE_GATE);

CCU_FACTOR_GATE_DEFINE(CLK_PLL1_D2, pll1_d2, "pll1", APBS_PLL1_SWCR2, BIT(1), 2, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_D3, pll1_d3, "pll1", APBS_PLL1_SWCR2, BIT(2), 3, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_D4, pll1_d4, "pll1", APBS_PLL1_SWCR2, BIT(3), 4, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_D5, pll1_d5, "pll1", APBS_PLL1_SWCR2, BIT(4), 5, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_D6, pll1_d6, "pll1", APBS_PLL1_SWCR2, BIT(5), 6, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_D7, pll1_d7, "pll1", APBS_PLL1_SWCR2, BIT(6), 7, 1);
CCU_FACTOR_GATE_FLAGS_DEFINE(CLK_PLL1_D8, pll1_d8, "pll1", APBS_PLL1_SWCR2, BIT(7),
			     8, 1, CLK_IS_CRITICAL);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_D11, pll1_d11_223p4, "pll1", APBS_PLL1_SWCR2,
		       BIT(15), 11, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_D13, pll1_d13_189, "pll1", APBS_PLL1_SWCR2,
		       BIT(16), 13, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_D23, pll1_d23_106p8, "pll1", APBS_PLL1_SWCR2,
		       BIT(20), 23, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_D64, pll1_d64_38p4, "pll1", APBS_PLL1_SWCR2,
		       BIT(0), 64, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_D10_AUD, pll1_aud_245p7, "pll1", APBS_PLL1_SWCR2,
		       BIT(10), 10, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_D100_AUD, pll1_aud_24p5, "pll1", APBS_PLL1_SWCR2,
		       BIT(11), 100, 1);

CCU_FACTOR_GATE_DEFINE(CLK_PLL2_D1, pll2_d1, "pll2", APBS_PLL2_SWCR2, BIT(0), 1, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL2_D2, pll2_d2, "pll2", APBS_PLL2_SWCR2, BIT(1), 2, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL2_D3, pll2_d3, "pll2", APBS_PLL2_SWCR2, BIT(2), 3, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL2_D4, pll2_d4, "pll2", APBS_PLL2_SWCR2, BIT(3), 4, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL2_D5, pll2_d5, "pll2", APBS_PLL2_SWCR2, BIT(4), 5, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL2_D6, pll2_d6, "pll2", APBS_PLL2_SWCR2, BIT(5), 6, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL2_D7, pll2_d7, "pll2", APBS_PLL2_SWCR2, BIT(6), 7, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL2_D8, pll2_d8, "pll2", APBS_PLL2_SWCR2, BIT(7), 8, 1);

CCU_FACTOR_GATE_DEFINE(CLK_PLL3_D1, pll3_d1, "pll3", APBS_PLL3_SWCR2, BIT(0), 1, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL3_D2, pll3_d2, "pll3", APBS_PLL3_SWCR2, BIT(1), 2, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL3_D3, pll3_d3, "pll3", APBS_PLL3_SWCR2, BIT(2), 3, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL3_D4, pll3_d4, "pll3", APBS_PLL3_SWCR2, BIT(3), 4, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL3_D5, pll3_d5, "pll3", APBS_PLL3_SWCR2, BIT(4), 5, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL3_D6, pll3_d6, "pll3", APBS_PLL3_SWCR2, BIT(5), 6, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL3_D7, pll3_d7, "pll3", APBS_PLL3_SWCR2, BIT(6), 7, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL3_D8, pll3_d8, "pll3", APBS_PLL3_SWCR2, BIT(7), 8, 1);

CCU_FACTOR_DEFINE(CLK_PLL3_20, pll3_20, "pll3_d8", 20, 1);
CCU_FACTOR_DEFINE(CLK_PLL3_40, pll3_40, "pll3_d8", 10, 1);
CCU_FACTOR_DEFINE(CLK_PLL3_80, pll3_80, "pll3_d8", 5, 1);
/* APBS clocks end */

/* MPMU clocks start */
CCU_GATE_DEFINE(CLK_PLL1_307P2, pll1_d8_307p2, "pll1_d8", MPMU_ACGR, BIT(13), 0);

CCU_FACTOR_DEFINE(CLK_PLL1_76P8, pll1_d32_76p8, "pll1_d8_307p2", 4, 1);

CCU_FACTOR_DEFINE(CLK_PLL1_61P44, pll1_d40_61p44, "pll1_d8_307p2", 5, 1);

CCU_FACTOR_DEFINE(CLK_PLL1_153P6, pll1_d16_153p6, "pll1_d8", 2, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_102P4, pll1_d24_102p4, "pll1_d8", MPMU_ACGR,
		       BIT(12), 3, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_51P2, pll1_d48_51p2, "pll1_d8", MPMU_ACGR,
		       BIT(7), 6, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_51P2_AP, pll1_d48_51p2_ap, "pll1_d8", MPMU_ACGR,
		       BIT(11), 6, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_57P6, pll1_m3d128_57p6, "pll1_d8", MPMU_ACGR,
		       BIT(8), 16, 3);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_25P6, pll1_d96_25p6, "pll1_d8", MPMU_ACGR,
		       BIT(4), 12, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_12P8, pll1_d192_12p8, "pll1_d8", MPMU_ACGR,
		       BIT(3), 24, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_12P8_WDT, pll1_d192_12p8_wdt, "pll1_d8", MPMU_ACGR,
		       BIT(19), 24, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_6P4, pll1_d384_6p4, "pll1_d8", MPMU_ACGR,
		       BIT(2), 48, 1);

CCU_FACTOR_DEFINE(CLK_PLL1_3P2, pll1_d768_3p2, "pll1_d384_6p4", 2, 1);
CCU_FACTOR_DEFINE(CLK_PLL1_1P6, pll1_d1536_1p6, "pll1_d384_6p4", 4, 1);
CCU_FACTOR_DEFINE(CLK_PLL1_0P8, pll1_d3072_0p8, "pll1_d384_6p4", 8, 1);

CCU_GATE_DEFINE(CLK_PLL1_409P6, pll1_d6_409p6, "pll1_d6", MPMU_ACGR, BIT(0), 0);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_204P8, pll1_d12_204p8, "pll1_d6", MPMU_ACGR,
		       BIT(5), 2, 1);

CCU_GATE_DEFINE(CLK_PLL1_491, pll1_d5_491p52, "pll1_d5", MPMU_ACGR, BIT(21), 0);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_245P76, pll1_d10_245p76, "pll1_d5", MPMU_ACGR,
		       BIT(18), 2, 1);

CCU_GATE_DEFINE(CLK_PLL1_614, pll1_d4_614p4, "pll1_d4", MPMU_ACGR, BIT(15), 0);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_47P26, pll1_d52_47p26, "pll1_d4", MPMU_ACGR,
		       BIT(10), 13, 1);
CCU_FACTOR_GATE_DEFINE(CLK_PLL1_31P5, pll1_d78_31p5, "pll1_d4", MPMU_ACGR,
		       BIT(6), 39, 2);

CCU_GATE_DEFINE(CLK_PLL1_819, pll1_d3_819p2, "pll1_d3", MPMU_ACGR, BIT(14), 0);

CCU_GATE_DEFINE(CLK_PLL1_1228, pll1_d2_1228p8, "pll1_d2", MPMU_ACGR, BIT(16), 0);

CCU_GATE_DEFINE(CLK_SLOW_UART, slow_uart, "clock-32k", MPMU_ACGR, BIT(1),
		CLK_IGNORE_UNUSED);
CCU_DDN_DEFINE(CLK_SLOW_UART1, slow_uart1_14p74, "pll1_d16_153p6", MPMU_SUCCR,
	       16, 13, 0, 13, 2, 0);
CCU_DDN_DEFINE(CLK_SLOW_UART2, slow_uart2_48, "pll1_d4_614p4", MPMU_SUCCR_1,
	       16, 13, 0, 13, 2, 0);

CCU_GATE_DEFINE(CLK_WDT, wdt_clk, "pll1_d96_25p6", MPMU_WDTPCR, BIT(1), 0);

CCU_FACTOR_DEFINE(CLK_I2S_153P6, i2s_153p6, "pll1_d8_307p2", 2, 1);

static const char *i2s_153p6_base_parents[] = {
	"i2s_153p6",
	"pll1_d8_307p2",
};
CCU_MUX_DEFINE(CLK_I2S_153P6_BASE, i2s_153p6_base, i2s_153p6_base_parents,
	       MPMU_FCCR, 29, 1, 0);
...
CCU_MUX_GATE_DEFINE(CLK_I2S_SYSCLK_SRC, i2s_sysclk_src, i2s_sysclk_src_parents,
		    MPMU_ISCCR, 30, 1, BIT(31), 0);

CCU_DDN_DEFINE(CLK_I2S_SYSCLK, i2s_sysclk, "i2s_sysclk_src", MPMU_ISCCR,
	       0, 15, 15, 12, 1, 0);

CCU_FACTOR_DEFINE(CLK_I2S_BCLK_FACTOR, i2s_bclk_factor, "i2s_sysclk", 2, 1);
/*
 * Divider of i2s_bclk always implies a 1/2 factor, which is
 * described by i2s_bclk_factor.
 */
CCU_DIV_GATE_DEFINE(CLK_I2S_BCLK, i2s_bclk, "i2s_bclk_factor", MPMU_ISCCR,
		    27, 2, BIT(29), 0);
...
CCU_MUX_DEFINE(CLK_APB, apb_clk, apb_parents, MPMU_APBCSCR, 0, 2, 0);

CCU_GATE_DEFINE(CLK_WDT_BUS, wdt_bus_clk, "apb_clk", MPMU_WDTPCR, BIT(0), 0);

CCU_GATE_DEFINE(CLK_RIPC, ripc_clk, "apb_clk", MPMU_RIPCCR, 0x1, 0);
/* MPMU clocks end */
...
CCU_MUX_GATE_DEFINE(CLK_SSP3, ssp3_clk, ssp_parents, APBC_SSP3_CLK_RST, 4, 3,
		    BIT(1), 0);
 ...
 */
CCU_GATE_DEFINE(CLK_TWSI8, twsi8_clk, "pll1_d78_31p5", APBC_TWSI8_CLK_RST,
		BIT(1) | BIT(0), 0);
 ...
 */
CCU_GATE_DEFINE(CLK_SSPA0_I2S_BCLK, sspa0_i2s_bclk, "i2s_bclk",
		APBC_SSPA0_CLK_RST, BIT(3), 0);
CCU_GATE_DEFINE(CLK_SSPA1_I2S_BCLK, sspa1_i2s_bclk, "i2s_bclk",
...
CCU_MUX_GATE_DEFINE(CLK_SSPA0, sspa0_clk, sspa0_parents, APBC_SSPA0_CLK_RST,
		    4, 3, BIT(1), 0);
...
CCU_MUX_GATE_DEFINE(CLK_CAN0, can0_clk, can_parents, APBC_CAN0_CLK_RST, 4, 3,
		    BIT(1), 0);
CCU_GATE_DEFINE(CLK_CAN0_BUS, can0_bus_clk, "clock-24m", APBC_CAN0_CLK_RST,
		BIT(0), 0);

CCU_GATE_DEFINE(CLK_UART0_BUS, uart0_bus_clk, "apb_clk", APBC_UART1_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_UART2_BUS, uart2_bus_clk, "apb_clk", APBC_UART2_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_UART3_BUS, uart3_bus_clk, "apb_clk", APBC_UART3_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_UART4_BUS, uart4_bus_clk, "apb_clk", APBC_UART4_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_UART5_BUS, uart5_bus_clk, "apb_clk", APBC_UART5_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_UART6_BUS, uart6_bus_clk, "apb_clk", APBC_UART6_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_UART7_BUS, uart7_bus_clk, "apb_clk", APBC_UART7_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_UART8_BUS, uart8_bus_clk, "apb_clk", APBC_UART8_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_UART9_BUS, uart9_bus_clk, "apb_clk", APBC_UART9_CLK_RST,
		BIT(0), 0);

CCU_GATE_DEFINE(CLK_GPIO_BUS, gpio_bus_clk, "apb_clk", APBC_GPIO_CLK_RST,
		BIT(0), 0);

CCU_GATE_DEFINE(CLK_PWM0_BUS, pwm0_bus_clk, "apb_clk", APBC_PWM0_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM1_BUS, pwm1_bus_clk, "apb_clk", APBC_PWM1_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM2_BUS, pwm2_bus_clk, "apb_clk", APBC_PWM2_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM3_BUS, pwm3_bus_clk, "apb_clk", APBC_PWM3_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM4_BUS, pwm4_bus_clk, "apb_clk", APBC_PWM4_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM5_BUS, pwm5_bus_clk, "apb_clk", APBC_PWM5_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM6_BUS, pwm6_bus_clk, "apb_clk", APBC_PWM6_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM7_BUS, pwm7_bus_clk, "apb_clk", APBC_PWM7_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM8_BUS, pwm8_bus_clk, "apb_clk", APBC_PWM8_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM9_BUS, pwm9_bus_clk, "apb_clk", APBC_PWM9_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM10_BUS, pwm10_bus_clk, "apb_clk", APBC_PWM10_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM11_BUS, pwm11_bus_clk, "apb_clk", APBC_PWM11_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM12_BUS, pwm12_bus_clk, "apb_clk", APBC_PWM12_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM13_BUS, pwm13_bus_clk, "apb_clk", APBC_PWM13_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM14_BUS, pwm14_bus_clk, "apb_clk", APBC_PWM14_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM15_BUS, pwm15_bus_clk, "apb_clk", APBC_PWM15_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM16_BUS, pwm16_bus_clk, "apb_clk", APBC_PWM16_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM17_BUS, pwm17_bus_clk, "apb_clk", APBC_PWM17_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM18_BUS, pwm18_bus_clk, "apb_clk", APBC_PWM18_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_PWM19_BUS, pwm19_bus_clk, "apb_clk", APBC_PWM19_CLK_RST,
		BIT(0), 0);

CCU_GATE_DEFINE(CLK_SSP3_BUS, ssp3_bus_clk, "apb_clk", APBC_SSP3_CLK_RST,
		BIT(0), 0);

CCU_GATE_DEFINE(CLK_RTC_BUS, rtc_bus_clk, "apb_clk", APBC_RTC_CLK_RST,
		BIT(0), 0);

CCU_GATE_DEFINE(CLK_TWSI0_BUS, twsi0_bus_clk, "apb_clk", APBC_TWSI0_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_TWSI1_BUS, twsi1_bus_clk, "apb_clk", APBC_TWSI1_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_TWSI2_BUS, twsi2_bus_clk, "apb_clk", APBC_TWSI2_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_TWSI4_BUS, twsi4_bus_clk, "apb_clk", APBC_TWSI4_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_TWSI5_BUS, twsi5_bus_clk, "apb_clk", APBC_TWSI5_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_TWSI6_BUS, twsi6_bus_clk, "apb_clk", APBC_TWSI6_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_TWSI7_BUS, twsi7_bus_clk, "apb_clk", APBC_TWSI7_CLK_RST,
		BIT(0), 0);
/* Placeholder to workaround quirk of the register */
CCU_FACTOR_DEFINE(CLK_TWSI8_BUS, twsi8_bus_clk, "apb_clk", 1, 1);

CCU_GATE_DEFINE(CLK_TIMERS1_BUS, timers1_bus_clk, "apb_clk",
		APBC_TIMERS1_CLK_RST, BIT(0), 0);
CCU_GATE_DEFINE(CLK_TIMERS2_BUS, timers2_bus_clk, "apb_clk",
		APBC_TIMERS2_CLK_RST, BIT(0), 0);

CCU_GATE_DEFINE(CLK_AIB_BUS, aib_bus_clk, "apb_clk", APBC_AIB_CLK_RST,
		BIT(0), 0);

CCU_GATE_DEFINE(CLK_ONEWIRE_BUS, onewire_bus_clk, "apb_clk",
		APBC_ONEWIRE_CLK_RST, BIT(0), 0);

CCU_GATE_DEFINE(CLK_SSPA0_BUS, sspa0_bus_clk, "apb_clk", APBC_SSPA0_CLK_RST,
		BIT(0), 0);
CCU_GATE_DEFINE(CLK_SSPA1_BUS, sspa1_bus_clk, "apb_clk", APBC_SSPA1_CLK_RST,
		BIT(0), 0);

CCU_GATE_DEFINE(CLK_TSEN_BUS, tsen_bus_clk, "apb_clk", APBC_TSEN_CLK_RST,
		BIT(0), 0);

CCU_GATE_DEFINE(CLK_IPC_AP2AUD_BUS, ipc_ap2aud_bus_clk, "apb_clk",
...
CCU_MUX_DIV_FC_DEFINE(CLK_PMUA_ACLK, pmua_aclk, pmua_aclk_parents,
		      APMU_ACLK_CLK_CTRL, 1, 2, BIT(4), 0, 1, 0);
...
CCU_MUX_DIV_FC_DEFINE(CLK_CCI550, cci550_clk, cci550_clk_parents,
		      APMU_CCI550_CLK_CTRL, 8, 3, BIT(12), 0, 2,
		      CLK_IS_CRITICAL);
...
CCU_MUX_DEFINE(CLK_CPU_C0_HI, cpu_c0_hi_clk, cpu_c0_hi_clk_parents,
...
CCU_MUX_FC_DEFINE(CLK_CPU_C0_CORE, cpu_c0_core_clk, cpu_c0_clk_parents,
		  APMU_CPU_C0_CLK_CTRL, BIT(12), 0, 3, CLK_IS_CRITICAL);
CCU_DIV_DEFINE(CLK_CPU_C0_ACE, cpu_c0_ace_clk, "cpu_c0_core_clk",
	       APMU_CPU_C0_CLK_CTRL, 6, 3, CLK_IS_CRITICAL);
CCU_DIV_DEFINE(CLK_CPU_C0_TCM, cpu_c0_tcm_clk, "cpu_c0_core_clk",
...
CCU_MUX_DEFINE(CLK_CPU_C1_HI, cpu_c1_hi_clk, cpu_c1_hi_clk_parents,
...
CCU_MUX_FC_DEFINE(CLK_CPU_C1_CORE, cpu_c1_core_clk, cpu_c1_clk_parents,
		  APMU_CPU_C1_CLK_CTRL, BIT(12), 0, 3, CLK_IS_CRITICAL);
CCU_DIV_DEFINE(CLK_CPU_C1_ACE, cpu_c1_ace_clk, "cpu_c1_core_clk",
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_JPG, jpg_clk, jpg_parents, APMU_JPG_CLK_RES_CTRL,
...
CCU_MUX_GATE_DEFINE(CLK_CCIC2PHY, ccic2phy_clk, ccic2phy_parents,
...
CCU_MUX_GATE_DEFINE(CLK_CCIC3PHY, ccic3phy_clk, ccic3phy_parents,
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_CSI, csi_clk, csi_parents,
...
CCU_MUX_DIV_GATE_DEFINE(CLK_CAMM0, camm0_clk, camm_parents,
			APMU_CSI_CCIC2_CLK_RES_CTRL, 23, 4, 8, 2,
			BIT(28), 0);
CCU_MUX_DIV_GATE_DEFINE(CLK_CAMM1, camm1_clk, camm_parents,
			APMU_CSI_CCIC2_CLK_RES_CTRL, 23, 4, 8, 2,
			BIT(6), 0);
CCU_MUX_DIV_GATE_DEFINE(CLK_CAMM2, camm2_clk, camm_parents,
			APMU_CSI_CCIC2_CLK_RES_CTRL, 23, 4, 8, 2,
			BIT(3), 0);
...
CCU_MUX_DIV_GATE_DEFINE(CLK_ISP_CPP, isp_cpp_clk, isp_cpp_parents,
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_ISP_BUS, isp_bus_clk, isp_bus_parents,
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_ISP, isp_clk, isp_parents, APMU_ISP_CLK_RES_CTRL,
...
CCU_MUX_DIV_GATE_SPLIT_FC_DEFINE(CLK_DPU_MCLK, dpu_mclk, dpumclk_parents,
...
CCU_MUX_GATE_DEFINE(CLK_DPU_ESC, dpu_esc_clk, dpuesc_parents,
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_DPU_BIT, dpu_bit_clk, dpubit_parents,
...
CCU_MUX_DIV_GATE_SPLIT_FC_DEFINE(CLK_DPU_PXCLK, dpu_pxclk, dpupx_parents,
				 APMU_LCD_CLK_RES_CTRL2, APMU_LCD_CLK_RES_CTRL1,
				 17, 4, BIT(30), 21, 3, BIT(16), 0);

CCU_GATE_DEFINE(CLK_DPU_HCLK, dpu_hclk, "pmua_aclk", APMU_LCD_CLK_RES_CTRL1,
		BIT(5), 0);
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_DPU_SPI, dpu_spi_clk, dpu_spi_parents,
			   APMU_LCD_SPI_CLK_RES_CTRL, 8, 3,
			   BIT(7), 12, 3, BIT(1), 0);
CCU_GATE_DEFINE(CLK_DPU_SPI_HBUS, dpu_spi_hbus_clk, "pmua_aclk",
		APMU_LCD_SPI_CLK_RES_CTRL, BIT(3), 0);
CCU_GATE_DEFINE(CLK_DPU_SPIBUS, dpu_spi_bus_clk, "pmua_aclk",
		APMU_LCD_SPI_CLK_RES_CTRL, BIT(5), 0);
CCU_GATE_DEFINE(CLK_DPU_SPI_ACLK, dpu_spi_aclk, "pmua_aclk",
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_V2D, v2d_clk, v2d_parents,
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_CCIC_4X, ccic_4x_clk, ccic_4x_parents,
...
CCU_MUX_GATE_DEFINE(CLK_CCIC1PHY, ccic1phy_clk, ccic1phy_parents,
		    APMU_CCIC_CLK_RES_CTRL, 7, 1, BIT(5), 0);

CCU_GATE_DEFINE(CLK_SDH_AXI, sdh_axi_aclk, "pmua_aclk", APMU_SDH0_CLK_RES_CTRL,
		BIT(3), 0);
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_SDH0, sdh0_clk, sdh01_parents,
			   APMU_SDH0_CLK_RES_CTRL, 8, 3, BIT(11), 5, 3,
			   BIT(4), 0);
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_SDH1, sdh1_clk, sdh01_parents,
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_SDH2, sdh2_clk, sdh2_parents,
			   APMU_SDH2_CLK_RES_CTRL, 8, 3, BIT(11), 5, 3,
			   BIT(4), 0);

CCU_GATE_DEFINE(CLK_USB_AXI, usb_axi_clk, "pmua_aclk", APMU_USB_CLK_RES_CTRL,
		BIT(1), 0);
CCU_GATE_DEFINE(CLK_USB_P1, usb_p1_aclk, "pmua_aclk", APMU_USB_CLK_RES_CTRL,
		BIT(5), 0);
CCU_GATE_DEFINE(CLK_USB30, usb30_clk, "pmua_aclk", APMU_USB_CLK_RES_CTRL,
		BIT(8), 0);
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_QSPI, qspi_clk, qspi_parents,
			   APMU_QSPI_CLK_RES_CTRL, 9, 3, BIT(12), 6, 3,
			   BIT(4), 0);
CCU_GATE_DEFINE(CLK_QSPI_BUS, qspi_bus_clk, "pmua_aclk",
		APMU_QSPI_CLK_RES_CTRL, BIT(3), 0);
CCU_GATE_DEFINE(CLK_DMA, dma_clk, "pmua_aclk", APMU_DMA_CLK_RES_CTRL,
		BIT(3), 0);
...
CCU_MUX_GATE_DEFINE(CLK_AES, aes_clk, aes_parents, APMU_AES_CLK_RES_CTRL,
		    6, 1, BIT(5), 0);
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_VPU, vpu_clk, vpu_parents, APMU_VPU_CLK_RES_CTRL,
			   13, 3, BIT(21), 10, 3, BIT(3), 0);
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_GPU, gpu_clk, gpu_parents, APMU_GPU_CLK_RES_CTRL,
			   12, 3, BIT(15), 18, 3, BIT(4), 0);
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_EMMC, emmc_clk, emmc_parents,
			   APMU_PMUA_EM_CLK_RES_CTRL, 8, 3, BIT(11),
			   6, 2, BIT(4), 0);
CCU_DIV_GATE_DEFINE(CLK_EMMC_X, emmc_x_clk, "pll1_d2_1228p8",
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_AUDIO, audio_clk, audio_parents,
...
CCU_MUX_DIV_GATE_FC_DEFINE(CLK_HDMI, hdmi_mclk, hdmi_parents,
			   APMU_HDMI_CLK_RES_CTRL, 1, 4, BIT(29), 5,
			   3, BIT(0), 0);

CCU_GATE_DEFINE(CLK_PCIE0_MASTER, pcie0_master_clk, "pmua_aclk",
		APMU_PCIE_CLK_RES_CTRL_0, BIT(2), 0);
CCU_GATE_DEFINE(CLK_PCIE0_SLAVE, pcie0_slave_clk, "pmua_aclk",
		APMU_PCIE_CLK_RES_CTRL_0, BIT(1), 0);
CCU_GATE_DEFINE(CLK_PCIE0_DBI, pcie0_dbi_clk, "pmua_aclk",
		APMU_PCIE_CLK_RES_CTRL_0, BIT(0), 0);

CCU_GATE_DEFINE(CLK_PCIE1_MASTER, pcie1_master_clk, "pmua_aclk",
		APMU_PCIE_CLK_RES_CTRL_1, BIT(2), 0);
CCU_GATE_DEFINE(CLK_PCIE1_SLAVE, pcie1_slave_clk, "pmua_aclk",
		APMU_PCIE_CLK_RES_CTRL_1, BIT(1), 0);
CCU_GATE_DEFINE(CLK_PCIE1_DBI, pcie1_dbi_clk, "pmua_aclk",
		APMU_PCIE_CLK_RES_CTRL_1, BIT(0), 0);

CCU_GATE_DEFINE(CLK_PCIE2_MASTER, pcie2_master_clk, "pmua_aclk",
		APMU_PCIE_CLK_RES_CTRL_2, BIT(2), 0);
CCU_GATE_DEFINE(CLK_PCIE2_SLAVE, pcie2_slave_clk, "pmua_aclk",
		APMU_PCIE_CLK_RES_CTRL_2, BIT(1), 0);
CCU_GATE_DEFINE(CLK_PCIE2_DBI, pcie2_dbi_clk, "pmua_aclk",
		APMU_PCIE_CLK_RES_CTRL_2, BIT(0), 0);

CCU_GATE_DEFINE(CLK_EMAC0_BUS, emac0_bus_clk, "pmua_aclk",
		APMU_EMAC0_CLK_RES_CTRL, BIT(0), 0);
CCU_GATE_DEFINE(CLK_EMAC0_PTP, emac0_ptp_clk, "pll2_d6",
		APMU_EMAC0_CLK_RES_CTRL, BIT(15), 0);
CCU_GATE_DEFINE(CLK_EMAC1_BUS, emac1_bus_clk, "pmua_aclk",
		APMU_EMAC1_CLK_RES_CTRL, BIT(0), 0);
CCU_GATE_DEFINE(CLK_EMAC1_PTP, emac1_ptp_clk, "pll2_d6",
		APMU_EMAC1_CLK_RES_CTRL, BIT(15), 0);

CCU_GATE_DEFINE(CLK_EMMC_BUS, emmc_bus_clk, "pmua_aclk",
